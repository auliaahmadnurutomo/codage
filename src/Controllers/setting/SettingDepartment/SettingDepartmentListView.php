...
/**
 * Class SettingDepartmentListView
 * 
 * Handles the list view for department settings
 */
class SettingDepartmentListView extends SettingDepartmentController implements DefaultFactoryIndex
{
    use PageIndex;
