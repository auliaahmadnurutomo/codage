...
/**
 * Class SettingStaffPositionListView
 * 
 * Handles the list view for staff position settings
 */
class SettingStaffPositionListView extends SettingStaffPositionController implements DefaultFactoryIndex
{
    use PageIndex;
