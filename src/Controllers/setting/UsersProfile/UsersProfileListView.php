...
/**
 * Class UsersProfileListView
 * 
 * Handles the list view for user profiles
 */
class UsersProfileListView extends UsersProfileController implements DefaultFactoryIndex
{
    use PageIndex;
            ...
            $listData[] = [
                ...
                'btn_edit' => !$this->acl($this->controllerPath) ? '-' :
                    ButtonHelper::hrefRedirect(
                        target: url($this->controllerPath . '/detail/' . $key->uuid),
