...
<div class="d-flex justify-content-between d-md-none py-4">
    ...
    <div class="row col align-item-center justify-content-end">
        <button class="bg-light rounded-circle border border-lg text-muted ml-2" type="button" data-toggle="collapse" data-target="#collapse-filter" aria-expanded="false" aria-controls="collapse-filter">
            <i class="fa fa-ellipsis-h"></i>
        </button>
    </div>
</div>

<div id="page-header" class="justify-content-between d-none d-md-flex align-items-center p-3 bg-light">
                <div>
        ...
        <div class="col pg-idx rounded-lg bg-white">
            ...
            <div class="row d-flex justify-content-center justify-content-md-between">
                <div class="col-sm-2 col-md-3 my-2">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text " id="basic-addon1" style="width: 80px;"><small>Records</small></span>
                        </div>
                ...
                <nav id="paging-navigation" aria-label="navigation" class="my-2 col-md-3 text-primary d-flex justify-content-center justify-content-md-end">
                    {!! @$data_pagination !!}
                </nav>
            </div>
        </div>
